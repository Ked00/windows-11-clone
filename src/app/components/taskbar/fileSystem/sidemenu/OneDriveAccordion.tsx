      ...
      {isOpen.isShowing == true ? (
        <ul>
          <li className="flex mb-2 items-center">
            <ExpandArrow />
            <Image src="/../public/images/desk-sm.png" width={18} height={14} alt="house icon" className="ml-4 mr-1"/>
            <p className="text-sm ml-1">Desktop</p>
          </li>
          <li className="flex items-center mb-2">
            <ExpandArrow />
            <Image src="/../public/images/docs-sm.png" width={18} height={14} alt="house icon" className="ml-4 mr-1"/>
            <p className="text-sm ml-1">Documents</p>
          </li>
          <li className="flex items-center mb-2">
            <ExpandArrow />
            <Image src="/../public/images/pics-sm.png" width={18} height={14} alt="house icon" className="ml-4 mr-1"/>
